...
async def validate_document(
    ...
    rules_json: str | None = Form(None, description="Rules JSON string"),
    ...
    try:
        result = service.validate_document(pdf_path=upload.local_processing_path, rules_json_str=rules_json)
