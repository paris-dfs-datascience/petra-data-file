...
class ValidationService:
    ...
    def validate_document(
        ...
        rules = self.rule_service.load_rules(rules_json_path=rules_json_path, rules_json_str=rules_json_str)
        return self.pipeline.run(pdf_path=pdf_path, rules=rules)
